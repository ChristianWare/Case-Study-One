              ...
              <div className={styles.right}>
                <div className={styles.copyContainer}>
                  <p className={styles.copy}>
                    ...
                    provides lodging services to travelers at an affordable
                    price. We currently provide lodging for multiple properties
                    in the state of Arizona. We allow clients to booking
                    directly on our website, in addition to OTA platforms such
                    as Air bnb and VRBO. Plan your next vacation with Elite
                    Retreat Rentals.
                  </p>
                </div>
                {data.map((x, index) => (
